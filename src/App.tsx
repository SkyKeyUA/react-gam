        ...
        <div className="header__body body-header">
          <div className="body-header__container">
            ...
            <div className="body-header__actions actions-header">
              <Link to="" className="actions-header__location">
                <svg
                  width="17"
                  height="25"
                  viewBox="0 0 17 25"
              ...
              <div className="actions-header__phones phones-header">
                <div className="phones-header__items">
                  <Link to="tel:+380675561977" className="phones-header__phone">
                    067-556-19-77
                  </Link>
                  <button
                  ...
                  <ul className={`phones-header__list ${openNumber ? 'open' : ''}`}>
                    {phoneNumber.map((obj, index) => (
                      <li key={index}>
                        <Link to={`tel:${obj.fullNumber}`} className="phones-header__phone">
                          {obj.shortNumber}
                        </Link>
                      </li>
                    ))}
              ...
              <Link to="" className="actions-header__favorite">
                <svg
                  width="28"
                  height="27"
                  viewBox="0 0 28 27"
